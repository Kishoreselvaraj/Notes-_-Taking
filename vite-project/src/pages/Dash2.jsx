...
function Dash() {
  ...
  const deleteNote = (id) => {
    axios.delete(`http://localhost:3000/create/notes/${id}`)
      .then(() => {
  ...
  const toggleFavorite = (id) => {
    ...
    axios.put(`http://localhost:3000/create/notes/${id}`, updatedNote)
      .then(response => {
  ...
  const editNote = () => {
    axios.put(`http://localhost:3000/create/notes/${currentNote._id}`, currentNote)
      .then(response => {
  ...
  const handleCreateNote = () => {
    ...
    axios.post('http://localhost:3000/create/notes', newNote)
      .then(response => {
